						...
						<form role="form">
							<div class="card-body">
								<div class="form-group">
									<label for="exampleInputReligion1">Religion Name</label>
									<input type="text" class="form-control" id="exampleInputReligion1" placeholder="Religion Name">
								</div>
							</div>
